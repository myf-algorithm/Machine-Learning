...
def test_maxent():
    ...
    print("train test features %d, %d, %s" % (len(train_features), len(test_features), train_features[0]))
    time_2 = time.time()
    ...
    time_4 = time.time()
    print('predicting cost %d second' % (time_4 - time_3))
    score = accuracy_score(test_labels, test_predict)
    print("The accruacy socre is %1.4f" % score)
    # 全零数据
