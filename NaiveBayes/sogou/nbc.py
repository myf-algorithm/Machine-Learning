...
def TextProcessing(folder_path, test_size=0.2):
    ...
    :param test_size: 测试集占比，默认占所有数据集的百分之20
    :return all_words_list: 按词频降序排序的训练集列表
	:return train_data_list: 训练集列表
	:return test_data_list: 测试集列表
	:return train_class_list: 训练集标签列表
	:return test_class_list: 测试集标签列表
    """
...
def TextFeatures(train_data_list, test_data_list, feature_words):
    ...
    :return train_feature_list: 训练集向量化列表
    :return test_feature_list: 测试集向量化列表
    """
